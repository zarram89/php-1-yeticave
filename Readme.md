...
В программе БД, которую мы изучаем, вы будете работать с восемью типами столбцов.


Тип	Описание	Что содержит
INT	Целое число	Диапазон числа со знаком от –2147483648 до 2147483647
TINYINT	Целое малое число	Диапазон числа со знаком от –128 до 127
DECIMAL	Число с плавающей запятой	Может хранить число с дробными величинами. Подходит для финансов.
CHAR	Короткий текст	Текст длиной до 255 символов
TEXT	Длинный текст	Текст длиной до 65535 символов
DATE	Дата	Дата в диапазоне от «1000-01-01» до «9999-12-31»
DATETIME	Дата и время	Дата плюс время
TIMESTAMP	Дата и время	Дата и время в формате Unixtime
